...
class Glm4MoeModelReasoningParser(ReasoningParser):
    ...
    # ---------------------------------------------------------------------
    # FIXED: determine reasoning-state from accumulated text, not token IDs
    # ---------------------------------------------------------------------
    ...
    # ---------------------------------------------------------------------
    # FIXED: robust streaming parser using text-based state machine
    # ---------------------------------------------------------------------
    ...
    # ---------------------------------------------------------------------
    # ORIGINAL NON-STREAMING PARSER (unchanged)
    # ---------------------------------------------------------------------
    ...
    # ---------------------------------------------------------------------
    # ORIGINAL is_reasoning_end (unchanged)
    # ---------------------------------------------------------------------
    ...
    # ---------------------------------------------------------------------
    # ORIGINAL extract_content_ids (unchanged)
    # ---------------------------------------------------------------------
